...
-- Started on 2025-02-22 19:03:57 +07
...
--
-- TOC entry 3469 (class 1262 OID 16516)
...
CREATE TABLE public.admins (
    ...
    can_view_stats bit(1),
    can_view_logs bit(1),
    can_clients bit(1),
    can_hosts bit(1),
    can_orders bit(1),
    can_servers bit(1),
    can_monitor_srv bit(1),
    can_tech_support bit(1),
    can_tariffs bit(1),
    can_admins bit(1)
);
...
-- Name: backups uq_backups; Type: CONSTRAINT; Schema: public; Owner: -
--
...
-- Name: versions uq_versions; Type: CONSTRAINT; Schema: public; Owner: -
--
...
-- Name: UK_versions; Type: INDEX; Schema: public; Owner: -
--
...
-- Name: backup_name_unique; Type: INDEX; Schema: public; Owner: -
--
...
-- Completed on 2025-02-22 19:03:58 +07
